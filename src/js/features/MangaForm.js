...
export function createMangaFormElement(initialData = null) {
    ...
    const pathTooltip = "Enter the full path to the folder containing chapter images (e.g., 1.jpg, 2.jpg...). Subfolders are not supported.";
    ...
    form.appendChild(createFormGroup('Total Images', totalImagesInput, 'The total number of image files across all chapters.'));
    ...
    form.appendChild(createFormGroup('Total Chapters', totalChaptersInput, 'How many chapters does this series have? Used to calculate images per chapter.'));
